...
@section('content')
    ...
    <section class="md:pl-64 p-5 w-full md:pt-2">
        <div class="pt-10">
            <h1 class="text-3xl text-slate-600 font-semibold">Pelaporan</h1>
        </div>
        <div class="pt-10">
            {{-- Message --}}
            ...
            <div class="flex items-center gap-2 text-sm font-openSans text-gray-500">
                ...
                <h5 class="">Laporan yang belum diverifikasi</h5>
            </div>
                        ...
                        @foreach ($laporans as $index => $laporan)
                            <tr class="bg-white border-b-2">
                                ...
                                <td class="text-center py-3 px-4 flex-col items-center justify-center">
                                    ...
                                    <a href="{{ asset('assets/img/laporan/' . $laporan->foto_barang) }}" target="_blank">
                ...
                <div class="flex justify-between items-center mt-2 flex-wrap">
                    ...
                    @else
                        <div class="translate-x-2">
                            <p class="text-gray-500 font-openSans text-sm">*Tidak ada data laporan.</p>
                        </div>
                    @endif
                </div>
            </div>
