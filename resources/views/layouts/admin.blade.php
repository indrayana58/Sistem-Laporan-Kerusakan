    ...
    <section>
        <div class="fixed w-60">
            ...
            <div
                ...
                <ul class=" w-full mt-10 font-semibold ">
                    <li class="mb-2">
                    ...
                    <li class="mb-2">
                        <a href="{{ route('admin.rekap') }}"
                            class="flex items-center text-base p-4 rounded-md  hover:text-pine text-pistachio  space-x-2 transition duration-300 ease-in-out {{ Request::is('admin.rekap*') ? 'active' : '' }}">
