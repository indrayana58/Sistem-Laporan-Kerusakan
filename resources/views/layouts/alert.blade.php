@if (session('success'))
    <div id="success-alert" class="bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded relative"
        ...
        <button type="button" class="absolute top-0 bottom-0 right-0 px-4 py-3" data-dismiss-target="#success-alert">
...
@if (session('error'))
    <div id="error-alert" class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative"
        ...
        <button type="button" class="absolute top-0 bottom-0 right-0 px-4 py-3" data-dismiss-target="#error-alert">
